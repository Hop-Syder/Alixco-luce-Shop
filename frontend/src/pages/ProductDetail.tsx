  ...
  if (!product) {
    return (
      <div className="min-h-[calc(100vh-5rem)] flex flex-col items-center justify-center bg-[hsl(var(--background))]">
        ...
        <Link to="/products" className="btn-primary">Retour au catalogue</Link>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-[calc(100vh-5rem)] bg-[hsl(var(--background))] relative overflow-hidden">
      ...
      <main className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          <Link to="/products" className="text-stone-500 hover:text-[hsl(var(--primary))] transition-colors font-medium flex items-center text-sm tracking-wide">
