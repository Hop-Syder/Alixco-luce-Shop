            ...
            <form onSubmit={handleCheckout} className="space-y-5">
              <div>
                ...
                <input 
                  ...
                  className="w-full bg-[hsl(var(--surface-neutral))] border border-white/10 rounded-xl p-3 focus:ring-2 focus:ring-[hsl(var(--primary))] focus:border-transparent outline-none transition-all text-[hsl(var(--text-main))] placeholder:text-stone-600"
              ...
              <div>
                ...
                <textarea 
                  ...
                  className="w-full bg-[hsl(var(--surface-neutral))] border border-white/10 rounded-xl p-3 focus:ring-2 focus:ring-[hsl(var(--primary))] focus:border-transparent outline-none transition-all resize-none text-[hsl(var(--text-main))] placeholder:text-stone-600"
                  rows={3}
              ...
              >
                {isSubmitting ? t('cart.preparing') : t('cart.order_whatsapp')}
              </button>
