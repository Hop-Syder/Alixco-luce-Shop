      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-16">
          ...
          <div className="space-y-6">
            ...
            <p className="font-light text-stone-400 text-sm leading-relaxed pr-4">
              L'Art de l'Unique et le Raffinement du Sur-Mesure. Spécialistes de la personnalisation en art, joaillerie et mode pour affirmer votre style unique.
            </p>
        ...
        <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-stone-500 text-xs font-light">
            &copy; {currentYear} AlixcoLuxe. Tous droits réservés.
          </p>
